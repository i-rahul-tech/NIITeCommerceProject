...
<h1>Hello</h1>
	<table id="cart" class="table table-hover table-condensed">
						...
						<tr>
							<td data-th="Product">
								<div class="row">
									...
									<div class="col-sm-10">
										<h4 class="nomargin text-capitalize">${a.product.prod_name}</h4>
					...
					<tfoot>
						...
						<tr>
							<td><a href="${context}/continueshopping" class="btn btn-warning"><i class="fa fa-angle-left"></i> Continue Shopping</a></td>
