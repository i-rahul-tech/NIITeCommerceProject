...
<jsp:include page="/WEB-INF/views/header.jsp"></jsp:include>
		...
		<div><span class="text-success">${param.msg},&nbsp;<a href="${context}/login/user">Click Here To Continue</a></span></div>
		</c:if>
		<h2 style="margin-left:40px;"><b>Update Password</b></h2>
				...
				<form action="${context}/updatepassword" method="POST">
					...
					<tr>
					<td><input type="password" id="oldpwd" name="oldpwd" class="form-control" onblur="chkpwd()" /></td>
