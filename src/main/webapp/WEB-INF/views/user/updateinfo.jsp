 ...
 <jsp:include page="/WEB-INF/views/header.jsp"></jsp:include>
		...
		<h2 style="margin-left:210px;"><b>Update Info</b></h2>
				...
				<form action="${context}/updateuserinfo" method="POST"><br />
					...
					<tr>
					<td><input type="text" name="ufname" class="form-control" value="${user.ufname}" disabled="true"/></td>
					<td><input type="text" name="ulname" class="form-control" value="${user.ulname}" disabled="true"/></td>
					</tr>
					...
					<tr>
					<td><input type="text" name="dob" value="${user.dob}" class="form-control"/></td>
					</tr>
					...
					<tr>
					<td><input type="tel" name="contact" value = "${user.contact}" class="form-control"/></td>
					</tr>
					...
					<tr>
					<td><input type="text" name="pincode" value="${user.pincode}" class="form-control"/></td>
					</tr>
					...
					<tr>
					<td><input type="text" name="state" value="${user.state}" class="form-control"/></td>
