package niit.ecommerce.main.MainBackEnd.config;
...
@Configuration
@ComponentScan(basePackages={"niit.ecommerce.main.MainBackEnd"})
@EnableTransactionManagement
public class HibernateConfig {
	BasicDataSource dataSource;
	//Change the below final variable value based on database you choose
	
private final static String DATABASE_URL="jdbc:h2:tcp://localhost/~/EcomBackend";
...
private final static String DATABASE_PASSWORD="rahul123";
...
public SessionFactory getSessionFactory(DataSource datasource)
{
	...
	builder.scanPackages("niit.ecommerce.main.MainBackEnd.dto");
