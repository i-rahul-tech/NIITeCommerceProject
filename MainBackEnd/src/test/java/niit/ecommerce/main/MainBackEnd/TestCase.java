...
public class TestCase {
	...
	//@Test
		public void test1() {
			...
			user.setUfname("rahul");
			user.setUlname("kaushik");
			user.setGender("Male");
			user.setContact("9500000020");
			user.setUemail("rahul113@gmail.com");
			user.setEnable(true);
			user.setPassword("rahul");
			user.setRole("Customer");
			user.setAddress("New Delhi");
			user.setDob("12/05/1995");
			user.setState("New Delhi");
	...
	public void test3()
	{
		...
		supplier.setSname("Rahul");
		supplier.setSemail("rahul123@gmail.com");
		supplier.setPassword("rahul");
		supplier.setContact("9845885956");
		supplier.setAddress("Rani Bagh");
		supplier.setS_comp_name("Mozzie");
	...
	public void test18()
	{
		...
		List<Product> listp = productDao.getProductList();
